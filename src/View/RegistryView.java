...
public class RegistryView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Prename");

        jLabel6.setText("Surname");

        jLabel7.setText("Street");

        jLabel8.setText("Postale code");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistryView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistryView().setVisible(true);
            }
        });
    }
